...
namespace Library.API.Helpers
{
    public static class IEnumerableExtensions
    {
            ...
            string fields)
        {
            ...
            // expensive, so rather than do it for each object in the list, we do 
            // it once and resuse the results. After all part of the reflection is on the
            ...
            {
                // only public properties that match the fields should
                // be in the ExpandoObject.
            ...
            // run through the source of objects
